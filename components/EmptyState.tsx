    ...
    <div className="text-center py-20 px-5">
      ...
      {action && (
        <button
          ...
          className="bg-(--accent) text-white border-none px-7 py-2.5 rounded-full text-sm font-semibold cursor-pointer font-body hover:opacity-90 transition-opacity"
        >
          {action.label}
        </button>
      )}
